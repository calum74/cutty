...
Print any value, including ranges and values that lack stream and formatting support. Automatically prints the contents of ranges and tuples, or displays the type name and address for objects without ostream support.
...
Prints the values to the specified stream. A space is inserted between each value, and a newline is not appended.
